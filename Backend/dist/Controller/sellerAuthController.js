...
export const updateSellerDetails = async (req, res) => {
    try {
        ...
        const { businessName, businessEmail, businessAddress, phoneNum, category, openingHours, deliveryRadius, website, storeDescription, latitude, longitude } = req.body;
        ...
        if (storeDescription !== undefined && storeDescription !== '')
...
export const getSellerDetailsPublic = async (req, res) => {
    try {
...
export const getMySellerDetails = async (req, res) => {
    try {
